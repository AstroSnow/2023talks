...
\begin{itemize}
    ...
    \item Nanoflares in the chromosphere
...
\begin{frame}{Shock substructure - upper chromosphere}
\begin{columns}
\begin{column}{0.8\textwidth}
\begin{figure}
    %\centering
    \includegraphics[width=0.95\linewidth,clip=true,trim=1.2cm 0.8cm 0.9cm 0.8cm]{Figures/shocksub2_plot_upc.png}
    %\caption{Upper-chromosphere case showing the $v_x$ velocity (top left), $B_y$ magnetic field (top right), temperature (lower left) and density (lower right). For panel c, the reference temperature $T_0=6220$.}
    \label{fig:upperchromocontext}
\end{figure}
\end{column}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth,clip=true,trim=1.2cm 0.3cm 1.6cm 1.8cm]{Figures/tcomp_plot.png} \\
    \includegraphics[width=0.95\linewidth,clip=true,trim=0.4cm 0.3cm 0.1cm 1.8cm]{Figures/tcomp_ion_plot.png}
\end{figure}
\end{column}
